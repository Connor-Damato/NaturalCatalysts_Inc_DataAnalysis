...
% ENGR 132 
% Program Description 
%  This program plots the Michaelis-Menten plot and displays the 
%  Vmax and Km of 5 enzymes given a dataset of 2 tests for each of 10 
...
for column = 2:101
    ...
    v0 = M4_getVel_002_02(time, concentration);
...
for index = 1:5
    [vmax, km] = M4_plot_v0s_002_02(sub, cell2mat(avg_v0s(index)), index);
    fprintf("Enzyme %d:\n", index)
    fprintf("  Vmax = %.4f\n", vmax)
    fprintf("  Km = %.2f\n\n", km)
end
